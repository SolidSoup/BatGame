...
namespace BatGame
{
    class BatEnemy: Enemy
    {
        ...
        public BatEnemy(Texture2D t, GameObjectManager go, Point p, Grid g, Direction d, SubSquares sub, bool s, double speed, double m, bool a, int time, bool detect)
        ...
        /// <summary>
        /// Handles all movement, cardinal movements also have cases for idle movement, which is a 3x3 square
        /// </summary>
        public override void Move()
        {
            ...
            if (isFacing(Direction.Up) && canMove(Direction.Up))
            {
                ...
                if (steps > 1 && detected == false && !needToFindStart)
                {
                    steps = 0;
