...
namespace BatGame
{
    class SleepingBatEnemy : Enemy
    {
        ...
        public SleepingBatEnemy(Texture2D t, GameObjectManager go, Point p, Grid g, Direction d, SubSquares sub, bool s, double speed, double m, bool a, int time, bool detect)
